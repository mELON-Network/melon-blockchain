...
from melon.pools.pool_config import PoolWalletConfig
from melon.util.config import load_config, save_config, create_default_melon_config
...
def test_pool_config():
    ...
    create_default_melon_config(test_root, ["config.yaml"])
