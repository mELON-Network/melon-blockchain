...
from melon.wallet.puzzles.p2_conditions import puzzle_for_conditions
from melon.wallet.puzzles import singleton_top_layer
from melon.pools.pool_wallet_info import PoolState
...
This test suite aims to test:
    - melon.pools.pool_puzzles.py
    - melon.wallet.puzzles.pool_member_innerpuz.clvm
    - melon.wallet.puzzles.pool_waiting_room_innerpuz.clvm
"""
