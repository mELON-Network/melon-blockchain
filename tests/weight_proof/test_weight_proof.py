...
from melon.consensus.blockchain import Blockchain
...
from melon.server.start_full_node import SERVICE_NAME
...
from melon.consensus.pot_iterations import calculate_iterations_quality
from melon.full_node.weight_proof import (  # type: ignore
    WeightProofHandler,
