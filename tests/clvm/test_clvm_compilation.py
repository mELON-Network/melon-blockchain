...
from melon.types.blockchain_format.program import Program, SerializedProgram

wallet_program_files = set(
    [
        "melon/wallet/puzzles/calculate_synthetic_public_key.clvm",
        "melon/wallet/puzzles/cc.clvm",
        "melon/wallet/puzzles/chialisp_deserialisation.clvm",
        "melon/wallet/puzzles/rom_bootstrap_generator.clvm",
        "melon/wallet/puzzles/generator_for_single_coin.clvm",
        "melon/wallet/puzzles/genesis-by-coin-id-with-0.clvm",
        "melon/wallet/puzzles/genesis-by-puzzle-hash-with-0.clvm",
        "melon/wallet/puzzles/lock.inner.puzzle.clvm",
        "melon/wallet/puzzles/p2_conditions.clvm",
        "melon/wallet/puzzles/p2_delegated_conditions.clvm",
        "melon/wallet/puzzles/p2_delegated_puzzle.clvm",
        "melon/wallet/puzzles/p2_delegated_puzzle_or_hidden_puzzle.clvm",
        "melon/wallet/puzzles/p2_m_of_n_delegate_direct.clvm",
        "melon/wallet/puzzles/p2_puzzle_hash.clvm",
        "melon/wallet/puzzles/rl_aggregation.clvm",
        "melon/wallet/puzzles/rl.clvm",
        "melon/wallet/puzzles/sha256tree_module.clvm",
        "melon/wallet/puzzles/singleton_top_layer.clvm",
        "melon/wallet/puzzles/did_innerpuz.clvm",
        "melon/wallet/puzzles/decompress_puzzle.clvm",
        "melon/wallet/puzzles/decompress_coin_spend_entry_with_prefix.clvm",
        "melon/wallet/puzzles/decompress_coin_spend_entry.clvm",
        "melon/wallet/puzzles/block_program_zero.clvm",
        "melon/wallet/puzzles/test_generator_deserialize.clvm",
        "melon/wallet/puzzles/test_multiple_generator_input_arguments.clvm",
        "melon/wallet/puzzles/p2_singleton.clvm",
        "melon/wallet/puzzles/pool_waitingroom_innerpuz.clvm",
        "melon/wallet/puzzles/pool_member_innerpuz.clvm",
        "melon/wallet/puzzles/singleton_launcher.clvm",
        "melon/wallet/puzzles/p2_singleton_or_delayed_puzhash.clvm",
    ]
)

clvm_include_files = set(
    ["melon/wallet/puzzles/create-lock-puzzlehash.clvm", "melon/wallet/puzzles/condition_codes.clvm"]
)

CLVM_PROGRAM_ROOT = "melon/wallet/puzzles"
...
class TestClvmCompilation(TestCase):
    ...
    def test_all_programs_listed(self):
        """
        Checks to see if a new .clvm file was added to melon/wallet/puzzles, but not added to `wallet_program_files`
        """
