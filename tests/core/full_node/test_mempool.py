...
from melon.full_node.mempool import Mempool
from melon.full_node.full_node_api import FullNodeAPI
from melon.protocols import full_node_protocol
from melon.simulator.simulator_protocol import FarmNewBlockProtocol
from melon.types.announcement import Announcement
...
from melon.util.condition_tools import conditions_for_solution
...
from melon.util.api_decorators import api_request, peer_required, bytes_required
from melon.full_node.mempool_check_conditions import parse_condition_args, parse_condition
...
from melon.types.blockchain_format.program import Program, INFINITE_COST
from melon.consensus.condition_costs import ConditionCost
...
#                    assert npc_result.npc_list[0].conditions == []
    ...
    async def test_invalid_coin_spend_coin(self, two_nodes):
        ...
        blocks = bt.get_consecutive_blocks(
            ...
            farmer_reward_puzzle_hash=reward_ph,
            pool_reward_puzzle_hash=reward_ph,
            elonwallet_reward_puzzle_hash=reward_ph,
        )
        full_node_1, full_node_2, server_1, server_2 = two_nodes
