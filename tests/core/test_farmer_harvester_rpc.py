...
from melon.plotting.plot_tools import stream_plot_info_ph, stream_plot_info_pk
from melon.protocols import farmer_protocol
from melon.rpc.farmer_rpc_api import FarmerRpcApi
from melon.rpc.farmer_rpc_client import FarmerRpcClient
from melon.rpc.harvester_rpc_api import HarvesterRpcApi
from melon.rpc.harvester_rpc_client import HarvesterRpcClient
...
from melon.wallet.derive_keys import master_sk_to_wallet_sk, master_sk_to_pooling_authentication_sk
...
class TestRpc:
    ...
    async def test1(self, simulation):
        ...
        try:
            ...
            await client.set_reward_targets(encode_puzzle_hash(new_ph, "melon"), encode_puzzle_hash(new_ph_2, "melon"))
            ...
            await client.set_reward_targets(None, encode_puzzle_hash(new_ph_3, "melon"))
            ...
            assert config["farmer"]["melon_target_address"] == encode_puzzle_hash(new_ph, "melon")
            assert config["pool"]["melon_target_address"] == encode_puzzle_hash(new_ph_3, "melon")

            new_ph_3_encoded = encode_puzzle_hash(new_ph_3, "melon")
