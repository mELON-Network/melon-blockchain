...
from melonbip158 import PyBIP158

from melon.cmds.init_funcs import create_all_ssl, create_default_melon_config
from melon.full_node.bundle_tools import (
    best_solution_generator_from_template,
    detect_potential_template_generator,
    simple_solution_generator,
)
from melon.util.errors import Err
from melon.full_node.generator import setup_generator_args
from melon.full_node.mempool_check_conditions import GENERATOR_MOD
from melon.plotting.create_plots import create_plots
...
from melon.consensus.blockchain_interface import BlockchainInterface
from melon.consensus.coinbase import create_puzzlehash_for_pk, create_farmer_coin, create_pool_coin
from melon.consensus.constants import ConsensusConstants
from melon.consensus.default_constants import DEFAULT_CONSTANTS
from melon.consensus.deficit import calculate_deficit
from melon.consensus.full_block_to_block_record import block_to_block_record
from melon.consensus.make_sub_epoch_summary import next_sub_epoch_summary
from melon.consensus.cost_calculator import NPCResult, calculate_cost_of_program
from melon.consensus.pot_iterations import (
    calculate_ip_iters,
...
from melon.consensus.vdf_info_computation import get_signage_point_vdf_info
from melon.full_node.signage_point import SignagePoint
from melon.plotting.plot_tools import PlotInfo, load_plots, parse_plot_info
...
from melon.types.blockchain_format.foliage import Foliage, FoliageBlockData, FoliageTransactionBlock, TransactionsInfo
from melon.types.blockchain_format.pool_target import PoolTarget
from melon.types.blockchain_format.proof_of_space import ProofOfSpace
from melon.types.blockchain_format.reward_chain_block import RewardChainBlockUnfinished
from melon.types.blockchain_format.sized_bytes import bytes32
from melon.types.blockchain_format.slots import (
...
from melon.types.blockchain_format.vdf import VDFInfo, VDFProof
from melon.types.condition_with_args import ConditionWithArgs
from melon.types.end_of_slot_bundle import EndOfSubSlotBundle
from melon.types.full_block import FullBlock
from melon.types.generator_types import BlockGenerator, CompressorArg
from melon.types.spend_bundle import SpendBundle
from melon.types.unfinished_block import UnfinishedBlock
from melon.types.name_puzzle_condition import NPC
from melon.util.bech32m import encode_puzzle_hash
from melon.util.block_cache import BlockCache
from melon.util.condition_tools import ConditionOpcode, conditions_by_opcode
from melon.util.config import load_config, save_config
from melon.util.hash import std_hash
from melon.util.ints import uint8, uint16, uint32, uint64, uint128
from melon.util.keychain import Keychain, bytes_to_mnemonic
from melon.util.merkle_set import MerkleSet
from melon.util.prev_transaction_block import get_prev_transaction_block
from melon.util.path import mkdir
from melon.util.vdf_prover import get_vdf_info_and_proof
from tests.wallet_tools import WalletTool
from melon.wallet.derive_keys import (
...
class BlockTools:
    ...
    def __init__(
        ...
        create_default_melon_config(root_path)
        ...
        if len(self.pool_pubkeys) == 0 or len(self.farmer_pubkeys) == 0:
            raise RuntimeError("Keys not generated. Run `melon generate keys`")
    ...
    def init_plots(self, root_path: Path):
        ...
        try:
            ...
            args.pool_contract_address = encode_puzzle_hash(self.pool_ph, "melon")
...
def get_plot_dir() -> Path:
    cache_path = Path(os.path.expanduser(os.getenv("melon_ROOT", "~/.melon/"))) / "test-plots"
    mkdir(cache_path)
    return cache_path
