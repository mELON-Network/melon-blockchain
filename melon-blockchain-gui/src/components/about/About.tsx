...
import icon from '../../assets/img/melon_circle.svg';
  ...
  return (
    <html>
      ...
      <body>
        ...
        <Spacer />
        <div className="copyright">Copyright (c) 2021 mELON Network</div>
        <Spacer />
        <VersionsTable>
          {versions?.electron && (
            <tr>
        ...
        <BugReport
          href="https://github.com/Gold-Coin-Network/melon-blockchain/issues"
          target="_blank"
        >
          Report an issue
        </BugReport>
