...
import { CardHero, Flex, Link } from '@melon/core';
import { PlotHero as PlotHeroIcon } from '@melon/icons';
      ...
      <Grid xs={12} md={6} lg={5} item>
        <CardHero>
          ...
          <Typography variant="body1">
            <Trans>
              {
                'Plots are allocated space on your hard drive used to farm and earn melon. '
              }
              <Link
                target="_blank"
                href="https://github.com/mELON-Network/melon-blockchain/wiki/Network-Architecture"
              >
                Learn more
              </Link>
            </Trans>
