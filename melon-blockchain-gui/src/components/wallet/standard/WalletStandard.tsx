...
import { /* mojo_to_melon_string, */ melon_to_mojo } from '../../../util/melon';
  ...
  return (
    <Grid item xs={12}>
      <Box display="flex">
        ...
        <Box>
          <Typography variant="subtitle1">
            {mojo_to_melon_string(props.balance)} {currencyCode}
          </Typography>
        </Box>
      </Box>
    </Grid>
  ...
  return (
    <Card title={<Trans>Balance</Trans>}>
      <BalanceCardSubSection
        ...
        tooltip={
          <Trans>
            This is the total amount of melon in the blockchain at the current
      ...
      <BalanceCardSubSection
        ...
        tooltip={
          <Trans>
            This is the amount of melon that you can currently use to make
            transactions. It does not include pending farming rewards, pending
            incoming transactions, and melon that you have just spent but is not
...
function SendCard(props: SendCardProps) {
  ...
  function handleSubmit(data: SendTransactionData) {
    ...
    if (address.includes('colour')) {
      dispatch(
        openDialog(
          <AlertDialog>
            <Trans>
              Error: Cannot send melon to coloured address. Please enter a melon
              address.
            </Trans>
          </AlertDialog>,
        ),
    ...
    if (address.slice(0, 12) === 'melon_addr://') {
    ...
    const amountValue = Number.parseFloat(melon_to_mojo(amount));
    const feeValue = Number.parseFloat(melon_to_mojo(fee));
