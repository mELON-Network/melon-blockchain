...
describe('units', () => {
  describe('#getUnit', () => {
    it('gets unit of melon', () => {
      const result = units.getUnit('melon');
    ...
    it('gets unit of melon using alias', () => {
  ...
  describe('#getDisplay', () => {
    it('gets display of melon', () => {
      const result = units.getDisplay('melon');
  ...
  describe('#setUnit', () => {
    ...
    it('modifies an existing unit', () => {
      units.setUnit('melon', 9);

      const result = units.getUnit('melon');

      expect(result).toEqual(9);

      units.setUnit('melon', 1);
    });
  });
  describe('#setDisplay', () => {
    ...
    it('updates an existing display', () => {
      units.setDisplay('melon', {
        format: '{amount} TmELON',
        fractionDigits: 0,
      });
