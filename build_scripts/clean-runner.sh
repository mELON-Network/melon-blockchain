...
rm -rf ../venv || true
rm -rf venv || true
rm -rf melon_blockchain.egg-info || true
rm -rf build_scripts/final_installer || true
rm -rf build_scripts/dist || true
rm -rf build_scripts/pyinstaller || true
rm -rf melon-blockchain-gui/build || true
rm -rf melon-blockchain-gui/daemon || true
rm -rf melon-blockchain-gui/node_modules || true
