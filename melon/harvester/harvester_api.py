...
from melon.harvester.harvester import Harvester
from melon.plotting.plot_tools import PlotInfo, parse_plot_info
from melon.protocols import harvester_protocol
from melon.protocols.farmer_protocol import FarmingInfo
from melon.protocols.harvester_protocol import Plot
from melon.protocols.protocol_message_types import ProtocolMessageTypes
from melon.server.outbound_message import make_msg
...
class HarvesterAPI:
    ...
    async def new_signage_point_harvester(
        self, new_challenge: harvester_protocol.NewSignagePointHarvester, peer: WSmelonConnection
    ):
        """
