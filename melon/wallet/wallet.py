...
from melon.consensus.cost_calculator import calculate_cost_of_program, NPCResult
from melon.full_node.bundle_tools import simple_solution_generator
...
from melon.wallet.puzzles.p2_delegated_puzzle_or_hidden_puzzle import (
    DEFAULT_HIDDEN_PUZZLE_HASH,
    calculate_synthetic_secret_key,
    puzzle_for_pk,
    solution_for_conditions,
)
from melon.wallet.puzzles.puzzle_utils import (
...
from melon.wallet.secret_key_store import SecretKeyStore
from melon.wallet.sign_coin_spends import sign_coin_spends
...
class Wallet:
    ...
    async def create_spend_bundle_relative_melon(self, melon_amount: int, exclude: List[Coin]) -> SpendBundle:
        list_of_solutions = []
        utxos = None
        ...
        if melon_amount < 0:
            utxos = await self.select_coins(abs(melon_amount), exclude)
        else:
        ...
        melon_amount = spend_value + melon_amount
        ...
        for coin in utxos:
            ...
            if output_created is None:
                ...
                primaries = [{"puzzlehash": newpuzhash, "amount": melon_amount}]
