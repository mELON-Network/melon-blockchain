...
from melon.util.condition_tools import conditions_dict_for_solution
    ...
    try:
        ...
        for coinsol in trade_offer.coin_spends:
            ...
            if r:
                ...
                if "melon" in cc_discrepancies:
                    cc_discrepancies["melon"] = cc_discrepancies["melon"] + diff
                else:
                    cc_discrepancies["melon"] = diff
