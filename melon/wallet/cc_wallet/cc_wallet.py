...
from melon.protocols.wallet_protocol import PuzzleSolutionResponse
...
from melon.util.condition_tools import conditions_dict_for_solution, pkm_pairs_for_conditions_dict
from melon.util.ints import uint8, uint32, uint64, uint128
from melon.util.json_util import dict_to_json_str
from melon.wallet.block_record import HeaderBlockRecord
from melon.wallet.cc_wallet.cc_info import CCInfo
from melon.wallet.cc_wallet.cc_utils import (
    CC_MOD,
    SpendableCC,
...
from melon.wallet.puzzles.genesis_by_coin_id_with_0 import (
