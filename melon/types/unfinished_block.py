...
from melon.types.blockchain_format.foliage import Foliage, FoliageTransactionBlock, TransactionsInfo
...
from melon.types.blockchain_format.vdf import VDFProof
