...
from melon.consensus.block_rewards import calculate_base_elonwallet_reward, calculate_base_farmer_reward, calculate_pool_reward
from melon.consensus.blockchain_interface import BlockchainInterface
from melon.consensus.coinbase import create_elonwallet_coin, create_farmer_coin, create_pool_coin
...
from melon.full_node.mempool_check_conditions import get_name_puzzle_conditions
...
from melon.types.blockchain_format.reward_chain_block import RewardChainBlock, RewardChainBlockUnfinished
...
from melon.util.recursive_replace import recursive_replace
...
def create_foliage(
    ...
    elonwallet_reward_puzzlehash: bytes32,
    ...
    Args:
        ...
        elonwallet_reward_puzzlehash: where to pay out elonwallet reward
    ...
    if is_transaction_block:
        ...
        if height > 0:
            ...
            elonwallet_coin = create_elonwallet_coin(
                curr.height,
                constants.GENESIS_PRE_FARM_ELONWALLET_PUZZLE_HASH,
                calculate_base_elonwallet_reward(curr.height),
                constants.GENESIS_CHALLENGE,
            )
            
            assert curr.header_hash == prev_transaction_block.header_hash
            reward_claims_incorporated += [pool_coin, farmer_coin, elonwallet_coin]
...
def create_unfinished_block(
    ...
    elonwallet_reward_puzzle_hash: bytes32,
    pool_target: PoolTarget,
    get_plot_signature: Callable[[bytes32, G1Element], G2Element],
    get_pool_signature: Callable[[PoolTarget, Optional[G1Element]], Optional[G2Element]],
    ...
    Args:
        ...
        elonwallet_reward_puzzle_hash: where to pay out elonwallet rewards
