...
from melon.consensus.network_type import NetworkType
from melon.consensus.pot_iterations import calculate_iterations_quality, calculate_sp_interval_iters
from melon.farmer.farmer import Farmer
from melon.protocols import farmer_protocol, harvester_protocol
from melon.protocols.harvester_protocol import PoolDifficulty
...
from melon.util.api_decorators import api_request, peer_required
...
class FarmerAPI:
    ...
    async def new_proof_of_space(
        self, new_proof_of_space: harvester_protocol.NewProofOfSpace, peer: ws.WSmelonConnection
    ):
        """
