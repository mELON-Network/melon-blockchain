...
from melon.cmds.configure import configure_cmd
from melon.cmds.farm import farm_cmd
from melon.cmds.init import init_cmd
from melon.cmds.keys import keys_cmd
from melon.cmds.netspace import netspace_cmd
from melon.cmds.plots import plots_cmd
from melon.cmds.show import show_cmd
from melon.cmds.start import start_cmd
from melon.cmds.stop import stop_cmd
from melon.cmds.wallet import wallet_cmd
from melon.cmds.plotnft import plotnft_cmd
...
@click.group(
    help=f"\n  Manage melon blockchain infrastructure ({__version__})\n",
    epilog="Try 'melon start node', 'melon netspace -d 192', or 'melon show -s'",
...
@cli.command("version", short_help="Show melon version")
def version_cmd() -> None:
    print(__version__)


@cli.command("run_daemon", short_help="Runs melon daemon")
@click.pass_context
def run_daemon_cmd(ctx: click.Context) -> None:
    from melon.daemon.server import async_run_daemon
    import asyncio
