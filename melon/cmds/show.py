    ...
    try:
        ...
        if state:
            ...
            if synced:
                ...
                print("You may be able to expedite with 'melon show -a host:port' using a known node.\n")
        ...
        if block_by_header_hash != "":
            ...
            if block is not None:
                ...
                elonwallet_address = encode_puzzle_hash(block.elonwallet_puzzle_hash, address_prefix)
                ...
                print(
                    ...
                    f"Community Address      {elonwallet_address}\n"
