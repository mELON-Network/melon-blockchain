...
from melon.util.ints import uint64, uint32
...
from melon.consensus.coinbase import create_pool_coin, create_farmer_coin
from melon.consensus.block_rewards import calculate_pool_reward, calculate_base_farmer_reward
from melon.consensus.cost_calculator import NPCResult

"""
The purpose of this file is to provide a lightweight simulator for the testing of melonlisp smart contracts.
...
There is also a provided NodeClient object which implements many of the methods from melon.rpc.full_node_rpc_client
