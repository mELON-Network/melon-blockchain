...
required to run a [Timelord](https://github.com/mELON-Network/melon-blockchain/wiki/Timelords).
...
[install-timelord.sh](https://github.com/mELON-Network/melon-blockchain/blob/main/install-timelord.sh)
